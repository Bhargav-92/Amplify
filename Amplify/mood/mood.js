const audio = new Audio('./mood_link/1.mp3');
//audio.play();
...
const songs = [

    {
        ...
        poster:"./mood_img/1.jpg"
    },
    {
        id:'2',
        songName:` Subha hone na de <br> <div class="subtitle">pritam , Mika singh</div>`,
        poster:"./mood_img/2.jpg"
    },
    {
        id:'3',
        songName:`Uff teri adaa <br> <div class="subtitle">Shankar mahadev</div>`,
        poster:"./mood_img/3.jpg"
    },
    {
        id:'4',
        songName:`Sooraj ki baahon Mein <br> <div class="subtitle">Dominique</div>`,
        poster:"./mood_img/4.jpg"
    },
    {
        id:'5',
        songName:`Ik junoon <br> <div class="subtitle">vishal daldani</div>`,
        poster:"./mood_img/5.jpg"
    },
    {
        id:'6',
        songName:`Baaton ko teri <br> <div class="subtitle">arijit singh</div>`,
        poster:"./mood_img/6.jpg"
    },
    {
        id:'7',
        songName:`Pehli dafa <br> <div class="subtitle">Aitf aslam</div>`,
        poster:"./mood_img/7.jpg"
    },
    {
        id:'8',
        songName:`Enna sona <br> <div class="subtitle">Arijit singh</div>`,
        poster:"./mood_img/8.jpg"
    },
    {
        id:'9',
        songName:`Te ammo <br> <div class="subtitle">Pritam sunidhi</div>`,
        poster:"./mood_img/9.jpg"
    },
    
    {
        id:'10',
        songName:`Asal Mein <br> <div class="subtitle">Darshan raval</div>`,
        poster:"./mood_img/10.jpg"
    },
    {
        id:'11',
        songName:`Stay <br> <div class="subtitle">The Kid LAROI, Justin Bieber </div>`,
        poster:"./mood_img/11.jpg"
    },
    {
        id:'12',
        songName:`Industry-baby <br> <div class="subtitle">Lil Nas X</div>`,
        poster:"./mood_img/12.jpg"
    },
    {
        id:'13',
        songName:`Bad boy X Bad Girl <br> <div class="subtitle">Yo Yo Honey Singh, Shashwat Singh</div>`,
        poster:"./mood_img/13.jpg"
    },
    {
        id:'14',
        songName:` De tali<br> <div class="subtitle">Yo Yo Honey Singh</div>`,
        poster:"./mood_img/14.jpg"
    },
    {
        id:'15',
        songName:` Blinding Lights<br> <div class="subtitle">The Weeknd</div>`,
        poster:"./mood_img/15.jpg"
    },
 
    {
        id:'16',
        songName:`Pasoori <br> <div class="subtitle">Shae Gill , Ali sethi</div>`,
        poster:"./mood_img/16.jpg"
    },
 
    {
        id:'17',
        songName:`Meri jaan<br> <div class="subtitle">Neeti mohan</div>`,
        poster:"./mood_img/17.jpg"
    },
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        // console.log(index);
        audio.src = `./mood_link/${index}.mp3`;
        // poster_master_play.src= `/assets/songs/${index}.jpg`;
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `./mood_link/${index}.mp3`
        audio.play();
...
audio.addEventListener('ended', () => {
    ...
    index ++;
    audio.src = `./mood_link/${index}.mp3`;
    poster_master_play.src= `./mood_img/${index}.jpg`;
    audio.play();
    let songTitles = songs.filter((els) => {
        return els.id == index;
    });
