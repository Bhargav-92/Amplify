const audio = new Audio('./alone_link/1.mp3');
//audio.play();
...
const songs = [

    {
        ...
        poster:"./alone_img/1.jpg"
    },
    {
        id:'2',
        songName:`Pal <br> <div class="subtitle">Arjit Singh</div>`,
        poster:"./alone_img/2.jpg"
    },
    {
        id:'3',
        songName:`Tum Hi Ana <br> <div class="subtitle">Jubin Nutiyal</div>`,
        poster:"./alone_img/3.jpg"
    },
    {
        id:'4',
        songName:`Pachtaoge <br> <div class="subtitle">Arjit Singh</div>`,
        poster:"./alone_img/4.jpg"
    },
    {
        id:'5',
        songName:`Hamari Adhuri Kahani<br> <div class="subtitle">Arjit Singh</div>`,
        poster:"./alone_img/5.jpg"
    },
    {
        id:'6',
        songName:`Baaton Ko Teri <br> <div class="subtitle">Arjit Singh</div>`,
        poster:"./alone_img/6.jpg"
    },
    {
        id:'7',
        songName:`Kabira <br> <div class="subtitle">Rekha Bhardwaj</div>`,
        poster:"./alone_img/7.jpg"
    },
    {
        id:'8',
        songName:`Channa Mereya <br> <div class="subtitle">Arjit Singh</div>`,
        poster:"./alone_img/8.jpg"
    },
    {
        id:'9',
        songName:`Zaroorat <br> <div class="subtitle">Mustafa Zahid</div>`,
        poster:"./alone_img/9.jpg"
    },
    
    {
        id:'10',
        songName:`Tum Saath Hoo <br> <div class="subtitle">A R Rahman</div>`,
        poster:"./alone_img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        // console.log(index);
        audio.src = `./alone_link/${index}.mp3`;
        // poster_master_play.src= `/assets/songs/${index}.jpg`;
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `./alone_link/${index}.mp3`
        audio.play();
...
audio.addEventListener('ended', () => {
    ...
    index ++;
    audio.src = `./alone_link/${index}.mp3`;
    poster_master_play.src= `./alone_img/${index}.jpg`;
    audio.play();
    let songTitles = songs.filter((els) => {
        return els.id == index;
    });
