const audio = new Audio('./road_link/1.mp3');
//audio.play();
...
const songs = [
    ...
    {
        id:'1',
        songName:`Born to Run <br> <div class="subtitle">Bruce Springsteen</div>`,
        poster:"./road_img/1.jpg"
    },
    {
        id:'2',
        songName:`Swaha X Faded <br> <div class="subtitle">Mahim</div>`,
        poster:"./road_img/2.jpg"
    },
    {
        id:'3',
        songName:`One Kiss x i was never there <br> <div class="subtitle">Scottish</div>`,
        poster:"./road_img/3.jpg"
    },
    {
        id:'4',
        songName:`Call me everyday<br> <div class="subtitle">Chris Brown</div>`,
        poster:"./road_img/4.jpg"
    },
    {
        id:'5',
        songName:`Calm Down<br> <div class="subtitle">Selena Gomes </div>`,
        poster:"./road_img/5.jpg"
    },
    {
        id:'6',
        songName:`Money Heist Season 5`,
        poster:"./road_img/6.jpg"
    },
    {
        id:'7',
        songName:`No Hay Fallo<br> <div class="subtitle">Kali Uchis</div>`,
        poster:"./road_img/7.jpg"
    },
    {
        id:'8',
        songName:`No Pressure<br> <div class="subtitle">Justin Biebier</div>`,
        poster:"./road_img/8.jpg"
    },
    {
        id:'9',
        songName:`Teni Dorime <br> <div class="subtitle">Teni </div>`,
        poster:"./road_img/9.jpg"
    },
    
    {
        id:'10',
        songName:`Let me Down Slowly <br> <div class="subtitle">Alec Benjamin</div>`,
        poster:"./road_img/10.jpg"
    },
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        // console.log(index);
        audio.src = `./road_link/${index}.mp3`;
        // poster_master_play.src= `/assets/songs/${index}.jpg`;
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `./road_link/${index}.mp3`
        audio.play();
...
audio.addEventListener('ended', () => {
    ...
    index ++;
    audio.src = `./road_link/${index}.mp3`;
    poster_master_play.src= `./road_img/${index}.jpg`;
    audio.play();
    let songTitles = songs.filter((els) => {
        return els.id == index;
    });
