const audio = new Audio('./no_sleep_link/1.mp3');
//audio.play();
...
const songs = [

    {
        ...
        poster:"./no_sleep.img/1.jpg"
    },
    {
        id:'2',
        songName:`Oh Antava Mava <br> <div class="subtitle">Indravathi Chauhan</div>`,
        poster:"./no_sleep.img/2.jpg"
    },
    {
        id:'3',
        songName:`Bure Bure <br> <div class="subtitle">Robert Uhlmarash</div>`,
        poster:"./no_sleep.img/3.jpg"
    },
    {
        id:'4',
        songName:`O Saki Saki <br> <div class="subtitle">Tulsi Kumar</div>`,
        poster:"./no_sleep.img/4.jpg"
    },
    {
        id:'5',
        songName:`Ghungroo <br> <div class="subtitle">Arjit Singh</div>`,
        poster:"./no_sleep.img/5.jpg"
    },
    {
        id:'6',
        songName:`Soniye <br> <div class="subtitle">Himesh Reshammiya</div>`,
        poster:"./no_sleep.img/6.jpg"
    },
    {
        id:'7',
        songName:`Mast Kalander <br> <div class="subtitle">Mika Sinngh,Yo Yo Honey singh</div>`,
        poster:"./no_sleep.img/7.jpg"
    },
    {
        id:'8',
        songName:`Tujh Mein Rab Dikhta Hai <br> <div class="subtitle">Roop Kumar Rathod</div>`,
        poster:"./no_sleep.img/8.jpg"
    },
    {
        id:'9',
        songName:`Party Freak <br> <div class="subtitle">Chandan shetty</div>`,
        poster:"./no_sleep.img/9.jpg"
    },
    
    {
        id:'10',
        songName:`Desi Kalakar <br> <div class="subtitle">YO YO Honey Singh</div>`,
        poster:"./no_sleep.img/10.jpg"
    },
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        // console.log(index);
        audio.src = `./no_sleep_link/${index}.mp3`;
        // poster_master_play.src= `/assets/songs/${index}.jpg`;
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `./no_sleep_link/${index}.mp3`
        audio.play();
...
audio.addEventListener('ended', () => {
    ...
    index ++;
    audio.src = `./no_sleep_link/${index}.mp3`;
    poster_master_play.src= `./no_sleep.img/${index}.jpg`;
    audio.play();
    let songTitles = songs.filter((els) => {
        return els.id == index;
    });
