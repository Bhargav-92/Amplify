const audio = new Audio('./kk/1.mp3');
//audio.play();
...
const songs = [
    ...
    {
        id:'1',
        songName:`Sach Keh raha hai <br> <div class="subtitle">K . K .  </div>`,
        poster:"./kk_img/1.jpg"
    },
    {
        id:'2',
        songName:`Soniye  <br> <div class="subtitle">K . K .  </div>`,
        poster:"./kk_img/2.jpg"
    },
    {
        id:'3',
        songName:`Dill Ibaadat <br> <div class="subtitle">Atif Asslam</div>`,
        poster:"./kk_img/3.jpg"
    },
    {
        id:'4',
        songName:`Woh Lamhe <br> <div class="subtitle">K . K .  </div>`,
        poster:"./kk_img/4.jpg"
    },
    {
        id:'5',
        songName:`Haan tu hain <br> <div class="subtitle">K . K .  </div>`,
        poster:"./kk_img/5.jpg"
    },
    {
        id:'6',
        songName:`Phir Mohabbat <br> <div class="subtitle">K . K .  </div>`,
        poster:"./kk_img/6.jpg"
    },
    {
        id:'7',
        songName:`Tu hi Haqeekat <br> <div class="subtitle">K . K .  </div>`,
        poster:"./kk_img/6.jpg"
    },
    {
        id:'8',
        songName:`Zara sa <br> <div class="subtitle">K . K .  </div>`,
        poster:"./kk_img/7.jpg"
    },
    {
        id:'9',
        songName:`Hale Dill <br> <div class="subtitle">K . K .  </div>`,
        poster:"./kk_img/8.jpg"
    },
    {
        id:'10',
        songName:`Bas ek pal <br> <div class="subtitle">K . K .  </div>`,
        poster:"./kk_img/9.jpg"
    },
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        // console.log(index);
        audio.src = `./kk/${index}.mp3`;
        // poster_master_play.src= `/assets/songs/${index}.jpg`;
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `./kk/${index}.mp3`
        audio.play();
