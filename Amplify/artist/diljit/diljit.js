const audio = new Audio('/artist/diljit/diljit_link/1.mp3');
//audio.play();
...
const songs = [
    {
        id:'1',
        songName:`Koka <br> <div class="subtitle">Diljit Dosanjh</div>`,
        poster:"./diljit_img/1.jpg"
    },
    {
        id:'2',
        songName:`Caviar <br> <div class="subtitle">Diljit Dosanjh</div>`,
        poster:"./diljit_img/2.jpg"
    },
    {
        id:'3',
        songName:`Lemonade <br> <div class="subtitle">Diljit Dosanjh</div>`,
        poster:"./diljit_img/3.jpg"
    },
    {
        id:'4',
        songName:`Peaches <br> <div class="subtitle">Diljit Dosanjh</div>`,
        poster:"./diljit_img/4.jpg"
    },
    {
        id:'5',
        songName:`Red Chili <br> <div class="subtitle">Diljit Dosanjh</div>`,
        poster:"./diljit_img/5.jpg"
    },
    {
        id:'6',
        songName:`Vanilla <br> <div class="subtitle">Diljit Dosanjh</div>`,
        poster:"./diljit_img/6.jpg"
    },
    {
        id:'7',
        songName:`Unforgettable <br> <div class="subtitle">Diljit Dosanjh</div>`,
        poster:"./diljit_img/7.jpg"
    },
    {
        id:'8',
        songName:`Honsala Rakh <br> <div class="subtitle">Diljit Dosanjh</div>`,
        poster:"./diljit_img/8.jpg"
    },
    {
        id:'9',
        songName:`Sher <br> <div class="subtitle">Diljit Dosanjh</div>`,
        poster:"./diljit_img/9.jpg"
    },
    
    {
        id:'10',
        songName:`Lover <br> <div class="subtitle">Diljit Dosanjh</div>`,
        poster:"./diljit_img/10.jpg"
    },
]
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        // console.log(index);
        audio.src = `/artist/diljit/diljit_link/${index}.mp3`;
        // poster_master_play.src= `/assets/songs/${index}.jpg`;
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `/artist/diljit/diljit_link/${index}.mp3`
        audio.play();
...
audio.addEventListener('ended', () => {
    ...
    index ++;
    audio.src = `/artist/diljit/diljit_link/${index}.mp3`;
    poster_master_play.src= `./diljit_img/${index}.jpg`;
    audio.play();
    let songTitles = songs.filter((els) => {
        return els.id == index;
    });
