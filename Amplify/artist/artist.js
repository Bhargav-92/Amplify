const audio = new Audio('./artist/1.mp3');
//audio.play();
...
const songs = [
    {
        id:'1',
        songName:` Dill meri na sune  <br> <div class="subtitle">Atif aslam</div>`,
        poster:"./artist_img/1.jpg"
    },
    {
        id:'2',
        songName:`Dill diyan gallan <br> <div class="subtitle">Atif aslam</div>`,
        poster:"./artist_img/2.jpg"
    },
    {
        id:'3',
        songName:`janam janam <br> <div class="subtitle">Pritam , atif aslam</div>`,
        poster:"./artist_img/3.jpg"
    },
    {
        id:'4',
        songName:`AK47 <br> <div class="subtitle">Guru randhava</div>`,
        poster:"./artist_img/4.jpg"
    },
    {
        id:'5',
        songName:`Baby girl <br> <div class="subtitle">Guru randhava</div>`,
        poster:"./artist_img/5.jpg"
    },
    {
        id:'6',
        songName:`Naach meri Rani <br> <div class="subtitle">Guru randhava</div>`,
        poster:"./artist_img/6.jpg"
    },
    {
        id:'7',
        songName:`Dollar <br> <div class="subtitle">Sidhu Moose wala</div>`,
        poster:"./artist_img/7.jpg"
    },
    {
        id:'8',
        songName:`Outlaw <br> <div class="subtitle">Sidhu moose wala</div>`,
        poster:"./artist_img/8.jpg"
    },
    {
        id:'9',
        songName:`Same beef <br> <div class="subtitle">Sidhu moosewala</div>`,
        poster:"./artist_img/9.jpg"
    },
    
    {
        id:'10',
        songName:`Fake Smile  <br> <div class="subtitle">Alan Walker</div>`,
        poster:"./artist_img/10.jpg"
    },
    {
        id:'11',
        songName:`All Falls down <br> <div class="subtitle">Alan Walker</div>`,
        poster:"./artist_img/11.jpg"
    },
    {
        id:'12',
        songName:`Paradise <br> <div class="subtitle">Alan walker</div>`,
        poster:"./artist_img/12.jpg"
    },
    {
        id:'13',
        songName:`Har Har gange  <br> <div class="subtitle">Arijit singh</div>`,
        poster:"./artist_img/13.jpg"
    },
    {
        id:'14',
        songName:`Har kisi ko <br> <div class="subtitle">Chirantann bhatt, Atif alsam</div>`,
        poster:"./artist_img/14.jpg"
    },
    {
        id:'15',
        songName:`Hamdard <br> <div class="subtitle">Mithoon , Arijit singh</div>`,
        poster:"./artist_img/15.jpg"
    },
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        // console.log(index);
        audio.src = `./artist/${index}.mp3`;
        // poster_master_play.src= `/assets/songs/${index}.jpg`;
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `./artist/${index}.mp3`
        audio.play();
