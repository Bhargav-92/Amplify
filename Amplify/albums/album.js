const audio = new Audio('./album_link/1.mp3');
//audio.play();
...
const songs = [

    {
        ...
        poster:"./album_img/1.jpg"
    },
    {
        id:'2',
        songName:` Karpura gauram <br> karunavataram <br> <div class="subtitle">Rajan Mishra</div>`,
        poster:"./album_img/2.jpg"
    },
    {
        id:'3',
        songName:`The Nights<br> <div class="subtitle">Avicii</div>`,
        poster:"./album_img/3.jpg"
    },
    {
        id:'4',
        songName:`Ude dill befikre<br> <div class="subtitle">Benny Deyal</div>`,
        poster:"./album_img/4.jpg"
    },
    {
        id:'5',
        songName:`Summer High<br> <div class="subtitle">AP Dhillon</div>`,
        poster:"./album_img/5.jpg"
    },
    {
        id:'6',
        songName:` Brown Munde <br> <div class="subtitle">AP Dhillon</div>`,
        poster:"./album_img/6.jpg"
    },
    {
        id:'7',
        songName:`Kya Baat ay <br> <div class="subtitle">Harrdy Sadhu</div>`,
        poster:"./album_img/7.jpg"
    },
    {
        id:'8',
        songName:`Tere liye <br> <div class="subtitle">Atif Aslam</div>`,
        poster:"./album_img/8.jpg"
    },
    {
        id:'9',
        songName:`Tere sang yara  <br> <div class="subtitle">Atif Aslam</div>`,
        poster:"./album_img/9.jpg"
    },
    
    {
        id:'10',
        songName:`Tu Jaane na<br> <div class="subtitle">Atif Aslam</div>`,
        poster:"./album_img/10.jpg"
    },
    {
        id:'11',
        songName:`Dill Chori  <br> <div class="subtitle">Yo Yo Honey singh</div>`,
        poster:"./album_img/11.jpg"
    },
    {
        id:'12',
        songName:`Girl I need you <br> <div class="subtitle">Meet Bros</div>`,
        poster:"./album_img/12.jpg"
    },
    {
        id:'13',
        songName:`Har Har gange  <br> <div class="subtitle">Arijit singh</div>`,
        poster:"./album_img/13.jpg"
    },
    {
        id:'14',
        songName:`Har kisi ko <br> <div class="subtitle">Arijit singh</div>`,
        poster:"./album_img/14.jpg"
    },
    {
        id:'15',
        songName:`Humdard <br> <div class="subtitle">Arijit singh</div>`,
        poster:"./album_img/15.jpg"
    },
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        // console.log(index);
        audio.src = `./album_link/${index}.mp3`;
        // poster_master_play.src= `/assets/songs/${index}.jpg`;
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `./album_link/${index}.mp3`
        audio.play();
...
audio.addEventListener('ended', () => {
    ...
    index ++;
    audio.src = `./album_link/${index}.mp3`;
    poster_master_play.src= `./album_img/${index}.jpg`;
    audio.play();
    let songTitles = songs.filter((els) => {
        return els.id == index;
    });
