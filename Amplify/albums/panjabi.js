const audio = new Audio('./punjabi_link/1.mp3');
//audio.play();
...
const songs = [
    ...
    {
        id:'2',
        songName:`Horn Blow <br> <div class="subtitle">Harrdy Sandhu</div>`,
        poster:"../albums/img1/2.jpg"
    },
    {
        id:'3',
    ...
    {
        id:'4',
        songName:`Makhna <br> <div class="subtitle">Neha Kakkar</div>`,
        poster:"../img/4.jpg"
    },
    {
        id:'5',
    ...
    {
        id:'6',
        songName:`Brown Munde <br> <div class="subtitle">AP Dhillon,Gurinder Gill</div>`,
        poster:"../img/6.jpg"
    },
    {
        id:'7',
        songName:`Kya Baat Ay <br> <div class="subtitle">Harrdy Sandhu</div>`,
        poster:"../img/7.jpg"
    },
    {
        id:'8',
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        // console.log(index);
        audio.src = `./punjabi_link/${index}.mp3`;
        // poster_master_play.src= `/assets/songs/${index}.jpg`;
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `./punjabi_link/${index}.mp3`
        audio.play();
