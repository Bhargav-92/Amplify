const audio = new Audio('./morning/1.mp3');
//audio.play();
...
const songs = [
    ...
    {
        id:'1',
        songName:`Besabriyaan <br> <div class="subtitle">Armaan Malik</div>`,
        poster:"./morning_img/1.jpg"
    },
    {
        id:'2',
        songName:`Wake Up Sid! <br> <div class="subtitle">Shankar Mahadevan</div>`,
        poster:"./morning_img/2.jpg"
    },
    {
        id:'3',
        songName:`Brothers Anthem <br> <div class="subtitle">Vishal Dadlani,Ajay-Atul</div>`,
        poster:"./morning_img/3.jpg"
    },
    {
        id:'4',
        songName:`Tera Hone Laga Hoon <br> <div class="subtitle">Pritam,Atif Aslam</div>`,
        poster:"./morning_img/4.jpg"
    },
    {
        id:'5',
        songName:`Pehli Dafa <br> <div class="subtitle">Atif Aslam</div>`,
        poster:"./morning_img/5.jpg"
    },
    {
        id:'6',
        songName:`Bolo Har Har Har <br> <div class="subtitle">Badshah,Megha Dalton</div>`,
        poster:"./morning_img/6.jpg"
    },
    {
        id:'7',
        songName:`Ude Dil Befikre <br> <div class="subtitle">Benny Dayal</div>`,
        poster:"./morning_img/7.jpg"
    },
    {
        id:'8',
        songName:`Cazab Ka Hai Yeh Din <br> <div class="subtitle">Amaal Malik,Arjit Singh</div>`,
        poster:"./morning_img/8.jpg"
    },
    {
        id:'9',
        songName:`Sanam Re <br> <div class="subtitle">Arjit Singh</div>`,
        poster:"./morning_img/9.jpg"
    },
    
    {
        id:'10',
        songName:`Malang <br> <div class="subtitle">Ved Sharma</div>`,
        poster:"./morning_img/10.jpg"
    },
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        // console.log(index);
        audio.src = `./morning/${index}.mp3`;
        // poster_master_play.src= `/assets/songs/${index}.jpg`;
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `./morning/${index}.mp3`
        audio.play();
...
audio.addEventListener('ended', () => {
    ...
    index ++;
    audio.src = `./morning/${index}.mp3`;
    poster_master_play.src= `./morning_img/${index}.jpg`;
    audio.play();
    let songTitles = songs.filter((els) => {
        return els.id == index;
    });
