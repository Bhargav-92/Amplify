const audio = new Audio('./guj/1.mp3');
//audio.play();
...
const songs = [
    ...
    {
        id:'1',
        songName:`Kehvu ghanu ghanu che <br> <div class="subtitle">Parthiv gohil</div>`,
        poster:"./guj_img/1.jpg"
    },
    {
        id:'2',
        songName:` Dhun laagi  <br> <div class="subtitle>Sachin jigar</div>`,
        poster:"./guj_img/2.jpg"
    },
    {
        id:'3',
        songName:`Gori Radha ne kalo kaan<br> <div class="subtitle">Sachin jigar</div>`,
        poster:"./guj_img/3.jpg"
    },
    {
        id:'4',
        songName:`Gori Tame Manda lidha <br> <div class="subtitle">Umesh barot</div>`,
        poster:"./guj_img/4.jpg"
    },
    {
        id:'5',
        songName:`Chandaliyo <br> <div class="subtitle">Bhargav purohit</div>`,
        poster:"./guj_img/5.jpg"
    },
    {
        id:'6',
        songName:` Bol mari ambe <br> <div class="subtitle">kirtidan Gadhvi</div>`,
        poster:"./guj_img/6.jpg"
    },
    {
        id:'7',
        songName:`Nayan  <br> <div class="subtitle">Dhvani Bhanushali</div>`,
        poster:"./guj_img/7.jpg"
    },
    {
        id:'8',
        songName:`Moti verana <br> <div class="subtitle">Amit trivedi</div>`,
        poster:"./guj_img/8.jpg"
    },
    {
        id:'9',
        songName:`Rayfale Rahada Ramade <br> <div class="subtitle">Mahesh Vanzara</div>`,
        poster:"./guj_img/9.jpg"
    },
    
    {
        id:'10',
        songName:`Radha Ne Shyam <br> <div class="subtitle">Sachin-jigar</div>`,
        poster:"./guj_img/10.jpg"
    },
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        // console.log(index);
        audio.src = `./guj/${index}.mp3`;
        // poster_master_play.src= `/assets/songs/${index}.jpg`;
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `./guj/${index}.mp3`
        audio.play();
...
audio.addEventListener('ended', () => {
    ...
    index ++;
    audio.src = `./guj/${index}.mp3`;
    poster_master_play.src= `./guj_img/${index}.jpg`;
    audio.play();
    let songTitles = songs.filter((els) => {
        return els.id == index;
    });
