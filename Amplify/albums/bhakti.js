const audio = new Audio('./bhakti_link/1.mp3');
//audio.play();
...
const songs = [
    ...
    {
        id:'1',
        songName:`Hanuman Chalisha <br> <div class="subtitle">HariHaran</div>`,
        poster:"./img/1.jpg"
    },
    {
        id:'2',
    ...
    {
        id:'3',
        songName:`Mera Bhola Hai Bhandari  <br> <div class="subtitle">Hansraj Raghuwanshi</div>`,
        poster:"./img/3.jpg"
    },
    {
        id:'4',
        songName:`Shri Krishna Govind Hare<br> <div class="subtitle">Jubin Nautiyal</div>`,
        poster:"./img/4.jpg"
    },
    {
        id:'5',
        songName:`Kaun Kehte Hain 2<br> <div class="subtitle">Siddharth Mohan,Balkrishan Sharma</div>`,
        poster:"./img/5.jpg"
    },
    {
        id:'6',
        songName:`Aarti Kunj Bihari Ki <br> <div class="subtitle">Anuradha Paudwal</div>`,
        poster:"./img/6.jpg"
    },
    {
        id:'7',
        songName:`Deva Shree Ganesha <br> <div class="subtitle">Ajay Gogavale</div>`,
        poster:"./img/7.jpg"
    },
    {
        id:'8',
        songName:`Hammare Saath Shri Raghunath <br> <div class="subtitle">Ranjeet Singh Jadaun</div>`,
        poster:"./img/8.jpg"
    },
    {
        id:'9',
        songName:`Achutam Keshavam <br> <div class="subtitle">Vikram Hazra</div>`,
        poster:"./img/9.jpg"
    },
    
    {
        id:'10',
        songName:`Karpur Gauram <br> <div class="subtitle">Pawan Singh</div>`,
        poster:"./img/10.jpg"
    },
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        // console.log(index);
        audio.src = `./bhakti_link/${index}.mp3`;
        // poster_master_play.src= `/assets/songs/${index}.jpg`;
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `./bhakti_link/${index}.mp3`
        audio.play();
