const audio = new Audio('./remix/1.mp3');
//audio.play();
...
const songs = [
    ...
    {
        id:'1',
        songName:`Party Mashup`,
        poster:"./remix_img/1.jpg"
    },
    {
        id:'2',
        songName:`Sushant Singh Rajput`,
        poster:"./remix_img/2.jpg"
    },
    {
        id:'3',
        songName:`Zero Hour Mashup 2013`,
        poster:"./remix_img/3.jpg"
    },
    {
        id:'4',
        songName:`Roy Mashup<br>`,
        poster:"./remix_img/4.jpg"
    },
    {
        id:'5',
        songName:`Breakup Mashup`,
        poster:"./remix_img/5.jpg"
    },
    {
        id:'6',
        songName:`Love Mashup`,
        poster:"./remix_img/6.jpg"
    },
    {
        id:'7',
        songName:`Valentine Mashup`,
        poster:"./remix_img/7.jpg"
    },
    {
        id:'8',
        songName:`Romantic Mashup`,
        poster:"./remix_img/8.jpg"
    },
    {
        id:'9',
        songName:`Jersey Mashup`,
        poster:"./remix_img/9.jpg"
    },
    
    {
        id:'10',
        songName:`Love Aaj Kal Mashup`,
        poster:"./remix_img/10.jpg"
    },
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        // console.log(index);
        audio.src = `./remix/${index}.mp3`;
        // poster_master_play.src= `/assets/songs/${index}.jpg`;
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `./remix/${index}.mp3`
        audio.play();
...
audio.addEventListener('ended', () => {
    ...
    index ++;
    audio.src = `./remix/${index}.mp3`;
    poster_master_play.src= `./remix_img/${index}.jpg`;
    audio.play();
    let songTitles = songs.filter((els) => {
        return els.id == index;
    });
